...
__decorate([
    (0, type_graphql_1.Field)({ description: 'room.state をJSON化したもの' }),
    __metadata("design:type", String)
...
__decorate([
    (0, type_graphql_1.Field)(() => OperatedBy, {
        nullable: true,
...
__decorate([
    (0, type_graphql_1.Field)({ description: 'room.upOperationをJSONにしたもの。idならばnullish。' }),
    __metadata("design:type", String)
...
__decorate([
    (0, type_graphql_1.Field)({ description: 'room.upOperationをJSONにしたもの' }),
    __metadata("design:type", String)
