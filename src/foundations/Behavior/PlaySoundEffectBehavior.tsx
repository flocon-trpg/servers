...
import { AllRoomMessagesResult, newEvent } from '../../hooks/useRoomMessages';
...
type PlaySoundEffectCoreProps = {
    value?: SoundEffect;
}

const PlaySoundEffectBehaviorCore: React.FC<PlaySoundEffectCoreProps> = ({ value }: PlaySoundEffectCoreProps) => {
...
type Props = {
    allRoomMesssagesResult: AllRoomMessagesResult;
}

const PlaySoundEffectBehavior: React.FC<Props> = ({ allRoomMesssagesResult }: Props) => {
    ...
    return <PlaySoundEffectBehaviorCore value={soundEffect} />;
};
