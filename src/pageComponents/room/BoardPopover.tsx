        ...
        case tachie:
            return (
                <div style={({
                    ...
                    {boardTooltipState.mouseOverOn.character.memo.trim() !== '' && <hr style={{ transform: 'scaleY(0.5)', borderWidth: '1px 0 0 0', borderStyle: 'solid', borderColor: '#FFFFFFD0' }} />}
                    <NewTabLinkify>
...
export const PopoverEditor: React.FC = () => {
    ...
    switch (popoverEditor.dblClickOn.type) {
        case dicePieceValue:
            children = <PopupEditorBase.DicePieceValue element={popoverEditor.dblClickOn.element} />;
            break;
        default:
            children = null;
            break;
...
namespace ContextMenuModule {
    ...
    const basicMenu = ({
        ...
        const { x, y } = toBoardPosition({ konvaOffset: { x: contextMenuState.offsetX, y: contextMenuState.offsetY }, boardConfig });
    ...
    export const Main: React.FC = () => {
        ...
        const onContextMenuClear = () => dispatch(roomDrawerAndPopoverModule.actions.set({ boardContextMenu: null }));

        return (
            <div style={({ position: 'absolute', left: contextMenuState.pageX, top: contextMenuState.pageY, zIndex })}>
                <Menu>
