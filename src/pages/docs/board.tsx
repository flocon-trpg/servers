    ...
    return (
        <Layout requiresLogin={false} showEntryForm={false}>
            <div css={$css}>
                ...
                <p>ボードビュアーにボードを表示させたい場合、まずはボードエディターでボードを作成します。ボードエディターで作成されるボードはデフォルトでは全て非公開の状態です。必要であればボードエディターでボードを編集しておきます。ボードを公開する準備ができたら、ボードビュアーウィンドウの右上の「表示ボードの変更」から、自分が作ったボードを選択します。これによりボードが全員に公開されます。</p>
