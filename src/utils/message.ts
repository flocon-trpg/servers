...
export const isDeleted = (message: Omit<RoomPublicMessage | RoomPrivateMessage, 'createdAt'>): boolean => {
...
export const toText = (message: Omit<RoomPublicMessage | RoomPrivateMessage, 'createdAt'>): string | null => {
