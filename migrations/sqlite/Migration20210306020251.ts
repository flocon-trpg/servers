...
export class Migration20210306020251 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `room` (`id` varchar not null, `version` integer not null default 1, `updated_at` datetime null, `join_as_player_phrase` varchar null, `join_as_spectator_phrase` varchar null, `created_by` varchar not null, `revision` integer not null, `name` varchar not null, primary key (`id`));');

    this.addSql('create table `room_op` (`id` varchar not null, `prev_revision` integer not null, `name` varchar null, primary key (`id`));');

    this.addSql('create table `room_prv_msg` (`id` varchar not null, `version` integer not null default 1, `created_at` datetime not null, `updated_at` datetime null, `text` varchar null, `text_updated_at` integer null default null, `text_color` varchar null, `command_result` varchar null, `command_is_success` integer null default null, `alt_text_to_secret` varchar null, `is_secret` integer not null, `chara_state_id` varchar null, `chara_name` varchar null, `custom_name` varchar null, primary key (`id`));');
    ...
    this.addSql('create table `remove_partici_op` (`id` varchar not null, `version` integer not null default 1, `name` varchar not null, `role` text check (`role` in (\'Player\', \'Spectator\', \'Master\')) null, primary key (`id`));');

    this.addSql('create table `removed_my_value` (`id` varchar not null, `state_id` varchar not null, `value` json not null, primary key (`id`));');
    this.addSql('create index `removed_my_value_state_id_index` on `removed_my_value` (`state_id`);');

    this.addSql('create table `removed_my_value_piece_by_partici` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, `is_private` integer not null, `is_cell_mode` integer not null, `x` integer not null, `y` integer not null, `w` integer not null, `h` integer not null, `cell_x` integer not null, `cell_y` integer not null, `cell_w` integer not null, `cell_h` integer not null, `version` integer not null default 1, primary key (`id`));');
    ...
    this.addSql('create table `add_my_value_op` (`id` varchar not null, `state_id` varchar not null, primary key (`id`));');
    this.addSql('create index `add_my_value_op_state_id_index` on `add_my_value_op` (`state_id`);');

    this.addSql('create table `remove_my_value_op` (`id` varchar not null, `state_id` varchar not null, `value` json not null, primary key (`id`));');
    this.addSql('create index `remove_my_value_op_state_id_index` on `remove_my_value_op` (`state_id`);');

    this.addSql('create table `removed_my_value_piece_by_my_value` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, `is_private` integer not null, `is_cell_mode` integer not null, `x` integer not null, `y` integer not null, `w` integer not null, `h` integer not null, `cell_x` integer not null, `cell_y` integer not null, `cell_w` integer not null, `cell_h` integer not null, `version` integer not null default 1, primary key (`id`));');
    ...
    this.addSql('create table `update_my_value_op` (`id` varchar not null, `state_id` varchar not null, `value` json not null, primary key (`id`));');
    this.addSql('create index `update_my_value_op_state_id_index` on `update_my_value_op` (`state_id`);');

    this.addSql('create table `add_my_value_piece_op` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, primary key (`id`));');
    ...
    this.addSql('create table `remove_my_value_piece_op` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, `is_private` integer not null, `is_cell_mode` integer not null, `x` integer not null, `y` integer not null, `w` integer not null, `h` integer not null, `cell_x` integer not null, `cell_y` integer not null, `cell_w` integer not null, `cell_h` integer not null, primary key (`id`));');
    ...
    this.addSql('create table `my_value` (`id` varchar not null, `state_id` varchar not null, `value` json not null, `version` integer not null default 1, primary key (`id`));');
    this.addSql('create index `my_value_state_id_index` on `my_value` (`state_id`);');

    this.addSql('create table `my_value_piece` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, `is_private` integer not null, `is_cell_mode` integer not null, `x` integer not null, `y` integer not null, `w` integer not null, `h` integer not null, `cell_x` integer not null, `cell_y` integer not null, `cell_w` integer not null, `cell_h` integer not null, `version` integer not null default 1, primary key (`id`));');
    ...
    this.addSql('create table `add_chara_piece_op` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, primary key (`id`));');
    ...
    this.addSql('create table `remove_chara_piece_op` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, `is_private` integer not null, `is_cell_mode` integer not null, `x` integer not null, `y` integer not null, `w` integer not null, `h` integer not null, `cell_x` integer not null, `cell_y` integer not null, `cell_w` integer not null, `cell_h` integer not null, primary key (`id`));');
    ...
    this.addSql('create table `update_chara_piece_op` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, `is_private` integer null, `is_cell_mode` integer null, `x` integer null, `y` integer null, `w` integer null, `h` integer null, `cell_x` integer null, `cell_y` integer null, `cell_w` integer null, `cell_h` integer null, primary key (`id`));');
    ...
    this.addSql('create table `removed_chara_piece` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, `is_private` integer not null, `is_cell_mode` integer not null, `x` integer not null, `y` integer not null, `w` integer not null, `h` integer not null, `cell_x` integer not null, `cell_y` integer not null, `cell_w` integer not null, `cell_h` integer not null, `version` integer not null default 1, primary key (`id`));');
    ...
    this.addSql('create table `chara_piece` (`id` varchar not null, `board_id` varchar not null, `board_created_by` varchar not null, `is_private` integer not null, `is_cell_mode` integer not null, `x` integer not null, `y` integer not null, `w` integer not null, `h` integer not null, `cell_x` integer not null, `cell_y` integer not null, `cell_w` integer not null, `cell_h` integer not null, `version` integer not null default 1, primary key (`id`));');
    ...
    this.addSql('alter table `remove_partici_op` add column `user_user_uid` varchar null;');
    this.addSql('alter table `remove_partici_op` add column `room_op_id` varchar null;');
    this.addSql('create index `remove_partici_op_user_user_uid_index` on `remove_partici_op` (`user_user_uid`);');
    this.addSql('create index `remove_partici_op_room_op_id_index` on `remove_partici_op` (`room_op_id`);');

    this.addSql('alter table `removed_my_value` add column `remove_partici_op_id` varchar null;');
    this.addSql('create index `removed_my_value_remove_partici_op_id_index` on `removed_my_value` (`remove_partici_op_id`);');

    this.addSql('alter table `removed_my_value_piece_by_partici` add column `removed_my_value_id` varchar null;');
    this.addSql('create index `removed_my_value_piece_by_partici_removed_my_value_id_index` on `removed_my_value_piece_by_partici` (`removed_my_value_id`);');

    this.addSql('alter table `update_partici_op` add column `user_user_uid` varchar null;');
    this.addSql('alter table `update_partici_op` add column `room_op_id` varchar null;');
    this.addSql('create index `update_partici_op_user_user_uid_index` on `update_partici_op` (`user_user_uid`);');
    this.addSql('create index `update_partici_op_room_op_id_index` on `update_partici_op` (`room_op_id`);');

    this.addSql('alter table `add_my_value_op` add column `update_partici_op_id` varchar null;');
    this.addSql('create index `add_my_value_op_update_partici_op_id_index` on `add_my_value_op` (`update_partici_op_id`);');

    this.addSql('alter table `remove_my_value_op` add column `update_partici_op_id` varchar null;');
    this.addSql('create index `remove_my_value_op_update_partici_op_id_index` on `remove_my_value_op` (`update_partici_op_id`);');

    this.addSql('alter table `removed_my_value_piece_by_my_value` add column `remove_my_value_op_id` varchar null;');
    this.addSql('create index `removed_my_value_piece_by_my_value_remove_my_value_op_id_index` on `removed_my_value_piece_by_my_value` (`remove_my_value_op_id`);');

    this.addSql('alter table `update_my_value_op` add column `update_partici_op_id` varchar null;');
    this.addSql('create index `update_my_value_op_update_partici_op_id_index` on `update_my_value_op` (`update_partici_op_id`);');

    this.addSql('alter table `add_my_value_piece_op` add column `update_my_value_op_id` varchar null;');
    this.addSql('create index `add_my_value_piece_op_update_my_value_op_id_index` on `add_my_value_piece_op` (`update_my_value_op_id`);');

    this.addSql('alter table `remove_my_value_piece_op` add column `update_my_value_op_id` varchar null;');
    this.addSql('create index `remove_my_value_piece_op_update_my_value_op_id_index` on `remove_my_value_piece_op` (`update_my_value_op_id`);');

    this.addSql('alter table `update_my_value_piece_op` add column `update_my_value_op_id` varchar null;');
    this.addSql('create index `update_my_value_piece_op_update_my_value_op_id_index` on `update_my_value_piece_op` (`update_my_value_op_id`);');

    this.addSql('alter table `add_partici_op` add column `user_user_uid` varchar null;');
    this.addSql('alter table `add_partici_op` add column `room_op_id` varchar null;');
    this.addSql('create index `add_partici_op_user_user_uid_index` on `add_partici_op` (`user_user_uid`);');
    this.addSql('create index `add_partici_op_room_op_id_index` on `add_partici_op` (`room_op_id`);');
    ...
    this.addSql('alter table `my_value` add column `partici_id` varchar null;');
    this.addSql('create index `my_value_partici_id_index` on `my_value` (`partici_id`);');

    this.addSql('alter table `my_value_piece` add column `my_value_id` varchar null;');
    this.addSql('create index `my_value_piece_my_value_id_index` on `my_value_piece` (`my_value_id`);');
    ...
    this.addSql('alter table `add_chara_piece_op` add column `update_chara_op_id` varchar null;');
    this.addSql('create index `add_chara_piece_op_update_chara_op_id_index` on `add_chara_piece_op` (`update_chara_op_id`);');

    this.addSql('alter table `remove_chara_piece_op` add column `update_chara_op_id` varchar null;');
    this.addSql('create index `remove_chara_piece_op_update_chara_op_id_index` on `remove_chara_piece_op` (`update_chara_op_id`);');

    this.addSql('alter table `update_chara_piece_op` add column `update_chara_op_id` varchar null;');
    this.addSql('create index `update_chara_piece_op_update_chara_op_id_index` on `update_chara_piece_op` (`update_chara_op_id`);');
    ...
    this.addSql('alter table `removed_chara_piece` add column `remove_chara_op_id` varchar null;');
    this.addSql('create index `removed_chara_piece_remove_chara_op_id_index` on `removed_chara_piece` (`remove_chara_op_id`);');
    ...
    this.addSql('alter table `chara_piece` add column `chara_id` varchar null;');
    this.addSql('create index `chara_piece_chara_id_index` on `chara_piece` (`chara_id`);');
    ...
    this.addSql('create unique index `remove_partici_op_room_op_id_user_user_uid_unique` on `remove_partici_op` (`room_op_id`, `user_user_uid`);');

    this.addSql('create unique index `removed_my_value_remove_partici_op_id_state_id_unique` on `removed_my_value` (`remove_partici_op_id`, `state_id`);');

    this.addSql('create unique index `removed_my_value_piece_by_partici_board_id_board_created_by_removed_my_value_id_unique` on `removed_my_value_piece_by_partici` (`board_id`, `board_created_by`, `removed_my_value_id`);');

    this.addSql('create unique index `update_partici_op_room_op_id_user_user_uid_unique` on `update_partici_op` (`room_op_id`, `user_user_uid`);');

    this.addSql('create unique index `add_my_value_op_update_partici_op_id_state_id_unique` on `add_my_value_op` (`update_partici_op_id`, `state_id`);');

    this.addSql('create unique index `remove_my_value_op_update_partici_op_id_state_id_unique` on `remove_my_value_op` (`update_partici_op_id`, `state_id`);');

    this.addSql('create unique index `removed_my_value_piece_by_my_value_board_id_board_created_by_remove_my_value_op_id_unique` on `removed_my_value_piece_by_my_value` (`board_id`, `board_created_by`, `remove_my_value_op_id`);');

    this.addSql('create unique index `update_my_value_op_update_partici_op_id_state_id_unique` on `update_my_value_op` (`update_partici_op_id`, `state_id`);');

    this.addSql('create unique index `add_my_value_piece_op_board_id_board_created_by_update_my_value_op_id_unique` on `add_my_value_piece_op` (`board_id`, `board_created_by`, `update_my_value_op_id`);');

    this.addSql('create unique index `remove_my_value_piece_op_board_id_board_created_by_update_my_value_op_id_unique` on `remove_my_value_piece_op` (`board_id`, `board_created_by`, `update_my_value_op_id`);');

    this.addSql('create unique index `update_my_value_piece_op_board_id_board_created_by_update_my_value_op_id_unique` on `update_my_value_piece_op` (`board_id`, `board_created_by`, `update_my_value_op_id`);');

    this.addSql('create unique index `add_partici_op_room_op_id_user_user_uid_unique` on `add_partici_op` (`room_op_id`, `user_user_uid`);');
