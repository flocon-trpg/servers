...
export class Migration20210218165218 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "room" ("id" varchar(255) not null, "version" int4 not null default 1, "updated_at" timestamptz(0) null, "join_as_player_phrase" varchar(255) null, "join_as_spectator_phrase" varchar(255) null, "created_by" varchar(255) not null, "room_revision" int4 not null, "name" varchar(255) not null, "partici_revision" int4 not null);');
    ...
    this.addSql('create table "room_prv_msg" ("id" varchar(255) not null, "version" int4 not null default 1, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "text" varchar(65535) null, "text_color" varchar(255) null, "command_result" varchar(65535) null, "alt_text_to_secret" varchar(65535) null, "is_secret" bool not null, "chara_state_id" varchar(255) null, "chara_name" varchar(255) null, "custom_name" varchar(255) null, "created_by_user_uid" varchar(255) null, "room_id" varchar(255) not null);');
    ...
    this.addSql('create table "room_pub_msg" ("id" varchar(255) not null, "version" int4 not null default 1, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "text" varchar(65535) null, "text_color" varchar(255) null, "command_result" varchar(65535) null, "alt_text_to_secret" varchar(65535) null, "is_secret" bool not null, "chara_state_id" varchar(255) null, "chara_name" varchar(255) null, "custom_name" varchar(255) null, "room_pub_ch_id" varchar(255) not null, "created_by_user_uid" varchar(255) null);');
