...
const mikro_orm_2 = require("./graphql+mikro-orm/entities/participant/mikro-orm");
const mikro_orm_3 = require("./graphql+mikro-orm/entities/room/mikro-orm");
const mikro_orm_4 = require("./graphql+mikro-orm/entities/roomMessage/mikro-orm");
const mikro_orm_5 = require("./graphql+mikro-orm/entities/user/mikro-orm");
const entities = [
    mikro_orm_3.Room,
    mikro_orm_3.RoomOp,
    mikro_orm_4.RoomPubMsg,
    mikro_orm_4.RoomPrvMsg,
    mikro_orm_4.DicePieceValueLog,
    mikro_orm_4.NumberPieceValueLog,
    mikro_orm_4.RoomPubCh,
    mikro_orm_4.RoomSe,
    mikro_orm_5.User,
    mikro_orm_2.Participant,
    mikro_orm_1.File,
];
