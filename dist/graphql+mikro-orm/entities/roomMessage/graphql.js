...
exports.RoomMessage = type_graphql_1.createUnionType({
    name: 'RoomMessage',
    types: () => [RoomPublicMessage, RoomPrivateMessage, RoomPublicChannel, RoomSoundEffect],
    resolveType: value => {
...
exports.RoomMessageEvent = type_graphql_1.createUnionType({
    ...
    types: () => [RoomPublicMessage, RoomPrivateMessage, RoomPublicChannel, RoomSoundEffect, RoomPublicChannelUpdate, RoomPublicMessageUpdate, RoomPrivateMessageUpdate],
    resolveType: value => {
        switch (value.__tstype) {
            case exports.RoomPrivateMessageType:
                return RoomPrivateMessage;
