 ...
 */
export declare const useRoomMessages: <TCustomMessage, TGraphQLError>(roomClient: Pick<RoomClient<TCustomMessage, TGraphQLError>, "messages">, filter?: ((message: Message<TCustomMessage>) => boolean) | undefined) => {
