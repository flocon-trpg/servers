...
const templateBase = {
    ...
    bgms: createRecordValueTemplate(template$a), // keyはStrIndex5
    boolParamNames: createRecordValueTemplate(template$3), //keyはStrIndex20
    boards: createRecordValueTemplate(template$5), // keyはランダムなID
    characters: createRecordValueTemplate(template$c), // keyはランダムなID
    ...
    memos: createRecordValueTemplate(template$4), // keyはランダムなID
    numParamNames: createRecordValueTemplate(template$3), // keyはStrIndex20
    rollCalls: createRecordValueTemplate(template$1), // keyはランダムなID
