...
export declare const state: <T extends AnyTemplate>(source: T) => z.ZodType<State<T>>;
...
export declare const upOperation: <T extends AnyTemplate>(source: T) => z.ZodType<UpOperation<T>>;
...
export declare const downOperation: <T extends AnyTemplate>(source: T) => z.ZodType<DownOperation<T>>;
