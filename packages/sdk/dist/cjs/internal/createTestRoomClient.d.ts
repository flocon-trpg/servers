import { WritingMessageStatusInputType, WritingMessageStatusType } from '@flocon-trpg/graphql-documents';
...
export declare const createTestRoomClient: <TCustomMessage, TGraphQLError>(callback: {
    writingMessageStatus?: (inputType: WritingMessageStatusInputType, source: MockSource<TCustomMessage, TGraphQLError>) => void;
    unsubscribe?: (source: MockSource<TCustomMessage, TGraphQLError>) => void;
}) => {
    roomClient: RoomClient<TCustomMessage, TGraphQLError>;
    source: {
        clientStatus: {
            next: (update: Parameters<(update: (source: {
