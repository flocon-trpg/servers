...
var NodeCacheCore = require('node-cache');

function _interopDefault (e) { return e && e.__esModule ? e : { default: e }; }

var NodeCacheCore__default = /*#__PURE__*/_interopDefault(NodeCacheCore);
...
class NodeCache {
    cache;
    constructor(config) {
        this.cache = new NodeCacheCore__default.default(config);
    }
    ...
    async incrby(key, increment) {
        ...
        if (typeof value === 'string') {
            valueAsInt = utils.filterInt(value);
        }
