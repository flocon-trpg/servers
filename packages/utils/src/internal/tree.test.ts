...
describe('tree', () => {
    it('tests empty instance', () => {
        const actual = new Tree<string, string>('root');
        expect(actual.value).toEqual('root');
    ...
    it('tests ensure', () => {
...

        {
            ...
            expect(replacer).toHaveBeenCalledWith('init root');
            expect(actual.get([])).toEqual(Option.some('root'));
...

        {
            ...
            expect(replacer).toHaveBeenCalledWith('init1');
            expect(actual.get([])).toEqual(Option.some('root'));
...

        {
            ...
            expect(replacer).toHaveBeenCalledWith('init2');
            expect(actual.get([])).toEqual(Option.some('root'));
            expect(actual.get(['a'])).toEqual(Option.some('a'));
            expect(actual.get(['a', 'b'])).toEqual(Option.some('a/b'));
...

        {
            ...
            expect(replacer).toHaveBeenCalledWith('init3');
            expect(actual.get([])).toEqual(Option.some('root'));
            expect(actual.get(['a'])).toEqual(Option.some('a'));
            expect(actual.get(['a', 'b'])).toEqual(Option.some('a/b'));
...

        {
            ...
            expect(initValue).toHaveBeenCalledTimes(1);
            expect(replacer).toHaveBeenCalledWith('init4');
