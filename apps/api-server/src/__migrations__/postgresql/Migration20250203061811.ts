...
export class Migration20250203061811 extends Migration {
    override async up(): Promise<void> {
        ...
        this.addSql(
            `alter table "room_prv_msg" alter column "chara_image_source_type" type text using ("chara_image_source_type"::text);`,
        );
