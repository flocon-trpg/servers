...
class Migration20211201185931 extends migrations.Migration {
    async up() {
        this.addSql('create table "user" ("user_uid" varchar(255) not null, "baas_type" varchar(255) not null, "is_entry" bool not null);');
        ...
        this.addSql('create table "file_tag" ("id" varchar(255) not null, "name" varchar(255) not null, "user_user_uid" varchar(255) not null);');
        this.addSql('alter table "file_tag" add constraint "file_tag_pkey" primary key ("id");');
        this.addSql('create table "file_file_tags" ("file_filename" varchar(255) not null, "file_tag_id" varchar(255) not null);');
        this.addSql('alter table "file_file_tags" add constraint "file_file_tags_pkey" primary key ("file_filename", "file_tag_id");');
        ...
        this.addSql('create table "room_op" ("id" varchar(255) not null, "prev_revision" int4 not null, "value" jsonb not null, "room_id" varchar(255) not null);');
        ...
        this.addSql('create table "dice_piece_log" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "state_id" varchar(255) not null, "value" jsonb null, "room_id" varchar(255) not null);');
        this.addSql('alter table "dice_piece_log" add constraint "dice_piece_log_pkey" primary key ("id");');
        this.addSql('create index "dice_piece_log_state_id_index" on "dice_piece_log" ("state_id");');
        this.addSql('create table "string_piece_log" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "state_id" varchar(255) not null, "value" jsonb null, "room_id" varchar(255) not null);');
        this.addSql('alter table "string_piece_log" add constraint "string_piece_log_pkey" primary key ("id");');
        ...
        this.addSql('create table "room_se" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "file_path" varchar(255) not null, "file_source_type" varchar(255) not null, "volume" int4 not null, "created_by_user_uid" varchar(255) null, "room_id" varchar(255) not null);');
        this.addSql('alter table "room_se" add constraint "room_se_pkey" primary key ("id");');
        this.addSql('create table "participant" ("id" varchar(255) not null, "role" varchar(255) null, "name" varchar(255) null, "room_id" varchar(255) not null, "user_user_uid" varchar(255) not null);');
        ...
        this.addSql('alter table "participant" add constraint "participant_room_id_user_user_uid_unique" unique ("room_id", "user_user_uid");');
    }
}

exports.Migration20211201185931 = Migration20211201185931;
//# sourceMappingURL=Migration20211201185931.js.map
