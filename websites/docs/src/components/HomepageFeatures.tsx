    ...
    return (
        <div className={clsx('col col--4')}>
            <div className="text--center" style={{ padding: '20px 0' }}>
                <Svg className={styles.featureSvg} role="img" style={{ width: 100, height: 100 }} />
            </div>
            ...
            <div className="container">
                ...
                <div style={{ paddingTop: 48 }}>
                    ...
                    <ul className="checkmark" style={{ marginTop: 8 }}>
                        ...
                        <li>
                            セッションの進行に用いるメインチャンネルと、観戦者も利用できる雑談チャンネルの2種類からメッセージを投稿
                        </li>
                        <li>複数人にも送信可能な秘話</li>
                ...
                <div style={{ paddingTop: 48 }}>
                    ...
                    <ul className="checkmark" style={{ marginTop: 8 }}>
                        ...
                        <li>Amazon Web Services、Google Cloudなどの様々なクラウドサービスで運用</li>
                        <li>オンプレミスサーバーで運用</li>
                    </ul>
                </div>
                ...
                <div style={{ paddingTop: 48 }}>
                    <h2>公式サーバー</h2>
                    <div>
                        <a href="https://try.flocon.app/" target="_blank" rel="noopener noreferrer">
                            公式サーバー
                        </a>
